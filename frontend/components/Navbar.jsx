...
export default function Navbar() {
 ...
 return (
 <header className="sticky top-0 z-50 w-full border-b border-surface-border bg-surface/90 backdrop-blur-md transition-colors">
 ...
 className="flex items-center gap-2.5 pl-1 pr-3 py-1 rounded-full hover:bg-background-secondary transition-colors"
 >
 ...
 href="/profile"
 onClick={() => setMenuOpen(false)}
 className="block px-3 py-2 rounded-xl text-sm font-medium text-foreground hover:bg-background-secondary transition-colors"
 >
 Profile
 </Link>
 <Link
 ...
 <Link
 href="/login"
 className="hidden sm:block text-foreground-subtle hover:text-foreground transition-colors"
 >
 Log in
 </Link>
 <Link
