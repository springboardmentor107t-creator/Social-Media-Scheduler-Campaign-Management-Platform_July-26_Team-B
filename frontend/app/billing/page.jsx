...
export default function BillingPage() {
 ...
 <div className="space-y-5 pt-6 border-t border-surface-border ">
 <UsageBar
 ...
 <p className="text-xs font-semibold uppercase tracking-wide text-foreground-muted mb-4">
 Payment Method
 </p>
 <div className="flex items-center gap-3 p-4 rounded-xl border border-surface-border bg-surface/40 mb-4">
 <div className="w-10 h-7 rounded bg-background-secondary flex items-center justify-center text-white text-[10px] font-bold">
 VISA
 </div>
 <div>
 ...
 <p className="text-xs text-foreground-muted">Expires 08/28</p>
 </div>
 </div>
 <button className="w-full py-2.5 rounded-xl border border-surface-border text-sm font-medium hover:bg-background-secondary transition-colors">
 ...
 <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-green-500/10 text-green-700 capitalize">
 {inv.status}
 </span>
 </td>
 <td className="py-3.5 px-4 text-right">
 <button className="text-brand-600 text-xs font-medium hover:underline">
 Download
 </button>
 </td>
 </tr>
