      ...
      <body className="min-h-full flex flex-col relative overflow-x-hidden">
        <ToastProvider>
          <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none opacity-20">
            <div className="blob-1 absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full blur-[140px] transition-colors duration-500"></div>
            <div className="blob-2 absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full blur-[140px] transition-colors duration-500"></div>
          </div>
