...
function fieldClass(extra = "") {
  return `surface-field w-full px-4 py-2.5 rounded-xl bg-white/50 dark:bg-zinc-900/50 border border-slate-200 dark:border-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500 transition-all placeholder:text-slate-400 dark:placeholder:text-slate-600 ${extra}`;
}
  ...
  return (
    <DashboardShell>
      <div className="glass-panel p-6 sm:p-8 rounded-3xl">
        ...
        {message && (
          <div className="bg-green-500/10 border border-green-500/20 text-green-700 dark:text-green-400 text-sm mb-6 py-3 px-4 rounded-xl">
            {message}
          </div>
        )}
          ...
          <form onSubmit={handleSaveProfile} className="max-w-xl space-y-6">
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <label className="px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-800 text-sm font-medium hover:bg-slate-100 dark:hover:bg-zinc-800 cursor-pointer transition-colors">
                  Change Photo
        ...
        {activeTab === "account" && (
          <form onSubmit={handleSaveAccount} className="max-w-xl space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-zinc-900/50">
                <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-brand-500/10 text-brand-600 dark:text-brand-400">
            ...
            <div className="pt-6 border-t border-slate-200 dark:border-slate-800">
              <button
                ...
                className="text-red-600 dark:text-red-400 font-medium text-sm hover:bg-red-50 dark:hover:bg-red-950/30 px-4 py-2 rounded-lg transition-colors -ml-4"
              >
