...
export default function SocialAccountsPage() {
 ...
 <div
 key={platform}
 className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-5 rounded-2xl border border-surface-border bg-surface/30 hover:shadow-md transition-all gap-4"
 >
 ...
 <div>
 <p className="font-bold text-foreground capitalize">{platform}</p>
 <div className="flex items-center gap-2 mt-0.5">
 {connected ? (
 <>
 <span className="w-2 h-2 rounded-full bg-green-500"></span>
 <span className="text-xs text-foreground-muted ">{connected.account_name}</span>
 </>
 ) : (
 <>
 <span className="w-2 h-2 rounded-full bg-background-secondary "></span>
 <span className="text-xs text-foreground-muted ">Not connected</span>
 </>
 )}
 </div>
 </div>
 ...
 disabled={isBusy}
 className="px-4 py-2 rounded-lg border border-surface-border text-foreground text-sm font-medium hover:bg-background-secondary transition-colors disabled:opacity-50 w-full sm:w-auto"
 >
 ...
 disabled={isBusy}
 className="px-4 py-2 rounded-lg bg-background-secondary text-white text-sm font-medium hover:bg-background-secondary transition-colors disabled:opacity-50 shadow-sm w-full sm:w-auto"
 >
