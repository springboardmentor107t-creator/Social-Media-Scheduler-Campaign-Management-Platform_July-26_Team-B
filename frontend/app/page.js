...
export default function Home() {
 return (
 <div className="flex flex-col flex-1 items-center justify-center font-sans w-full max-w-7xl mx-auto px-6 py-20 text-center">
 
 {/* Hero Section */}
 <div className="space-y-6 max-w-3xl mx-auto mb-16 animate-in fade-in slide-in-from-bottom-8 duration-1000">
 <div className="inline-flex items-center rounded-full border border-brand-500/30 bg-brand-500/10 px-3 py-1 text-sm font-medium text-brand-600 mb-4">
 ...
 <p className="text-lg sm:text-xl text-foreground-subtle max-w-2xl mx-auto leading-relaxed">
 ...
 <Link
 href="/login"
 className="flex h-12 w-full sm:w-auto items-center justify-center rounded-full glass-panel px-8 font-medium transition-all hover:bg-surface/10"
 >
 Sign In
 </Link>
 </div>
 ...
 <div className="w-12 h-12 rounded-xl bg-brand-100 flex items-center justify-center text-brand-600 mb-4 text-2xl">
 📅
 </div>
 ...
 <div className="w-12 h-12 rounded-xl bg-purple-100 flex items-center justify-center text-purple-600 mb-4 text-2xl">
 📈
 </div>
 ...
 <div className="w-12 h-12 rounded-xl bg-blue-100 flex items-center justify-center text-blue-600 mb-4 text-2xl">
 ⚡
 </div>
