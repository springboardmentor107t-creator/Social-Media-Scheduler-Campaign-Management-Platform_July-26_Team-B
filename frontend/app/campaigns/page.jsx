  ...
  return (
    <DashboardShell>
      <div className="space-y-6">
        ...
        {/* Filter bar */}
        <div className="flex flex-wrap gap-2 p-1 bg-slate-100 dark:bg-zinc-900/50 border border-slate-200 dark:border-slate-800 rounded-xl w-fit">
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="h-48 bg-slate-100 dark:bg-zinc-900/50 rounded-2xl animate-pulse" />
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {filteredCampaigns.map((camp) => (
              <div
                ...
                className="glass-panel p-6 rounded-3xl cursor-pointer hover:-translate-y-1 hover:shadow-xl transition-all border border-slate-200/50 dark:border-slate-800/50 flex flex-col justify-between"
              >
                <div>
        ...
        {showModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
            <div className="glass-panel w-full max-w-lg rounded-3xl p-6 sm:p-8 bg-white dark:bg-zinc-950 shadow-2xl relative" onClick={(e) => e.stopPropagation()}>
              ...
              <h2 className="text-xl font-bold mb-1 tracking-tight">Create Campaign</h2>
              <p className="text-xs text-slate-400 mb-6">Create a new unified marketing container.</p>
